	...
	public void myPaymentsFilter() {
		for(int i=0; i<myPaymentFilter.size();i++) {
			...
			}else if(filterName.equals("Account Number"))
			{
				...
				xpath.sendKeys(searchElement);
				r1ComMethod.checkElementcontain(paymentsRowString, paymentsFilterHeaders, "Account Number", searchElement);
				xpath.clear();
				continue;
			 ...
			 else if(filterName.equals("Mode Description"))
			{
				...
				xpath.sendKeys(searchElement);
				r1ComMethod.checkElementcontain(paymentsRowString, paymentsFilterHeaders, "Mode Description", searchElement);
				xpath.clear();
				continue;
				...
				xpath.sendKeys(searchElement);
				r1ComMethod.checkElementcontain(paymentsRowString, paymentsFilterHeaders, "Flag Description", searchElement);
				xpath.clear();
				continue;
				...
				xpath.sendKeys(searchElement);
				r1ComMethod.checkElementcontain(paymentsRowString, paymentsFilterHeaders, "Payment Number", searchElement);
				xpath.clear();
				continue;
